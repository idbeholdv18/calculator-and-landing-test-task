...
interface I_LightModeProps {
    size?: E_IconSize;
    isActive?: boolean;
}

export const LightMode = (props: I_LightModeProps) => {
...
export const LightModeMemoized = memo(LightMode);

export type T_LightModeComponent = typeof LightModeMemoized;
